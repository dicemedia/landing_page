...
jQuery(document).ready(function($) {
	...
	// Navbar slide down animation on scroll
	...
	$navToggle.on('click', function(){
		$(this).toggleClass('active').parents('.navbar').find('.main-navigation').toggleClass('open');
	});
	...
	// Input focus
	var $fromControl = $('.form-control');
	$fromControl.on('focus', function(){
		$(this).parent().addClass('focused');
	});
	$fromControl.on('blur', function(){
	...
	var $checkbox = $('input[type="checkbox"], input[type="radio"]:not(.pricing-filter)');
	if($checkbox.length) {
		$('input').iCheck();
	}
